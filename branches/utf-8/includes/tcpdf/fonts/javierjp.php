<?php
/*
	This font definition is basically kozminproregular.php
...
$type = 'cidfont0';
// $name = 'KozMinPro-Regular-Acro';	// TCPDF name doesn't show the apostrophe, font is substituted and description used (less caps height)
// $name = 'KozMinProVI-Regular';	// Reader 8
$name = 'KozMinPr6N-Regular';		// Reader 9.1

// $displayname = 'Kozuka Mincho Pro (Japanese Serif)';
// $displayname = 'Kozuka Mincho Pro-VI R';	// Reader 8
$displayname = 'Kozuka Mincho Pro-6N R';	// Reader 9.1

// when client hasn't the font it uses the description.
$desc = array(
	'Ascent' => 880,
	'Descent' => -120,
	'CapHeight' => 740,
...
// width, dw is default width, CIDFonts default width is always 1000
$dw=1000;
$cw = array(
...
// CID Information
$enc='UniJIS-UTF16-H'; // if UCS2 then finish ij is not show
$cidinfo=array('Registry'=>'Adobe','Ordering'=>'Japan1','Supplement'=>6);
